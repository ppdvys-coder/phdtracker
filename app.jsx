...
const seed = () => { const S = ({
  ...
  conferences: [
    ...
    { _a:[], name:"AUDE27 — AUDE Annual Conference", series:"AUDE, annual", url:"https://www.aude.ac.uk/events/annual-conference/", targetYear:"2027", date:"2027-04-12", endDate:"2027-04-15", location:"University of Edinburgh", abstractDue:"", paperDue:"", regDue:"", status:"Watching", lastChecked:"2026-08-28", notes:"Association of University Directors of Estates — highly relevant to the smart-campus / university-estates PhD. Checked Aug 2026: dates & venue confirmed (‘Save the dates’), but REGISTRATION and CALL FOR PAPERS / submission details NOT yet released. Contact info@aude.ac.uk. Re-check the site for CFP + registration → then fill Abstract due / Register by so it counts down." },
  ],
  publications: [
