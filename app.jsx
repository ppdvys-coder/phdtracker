...
const seed = () => { const S = ({
  ...
  conferences: [
    { _a:[], name:"PRRES 2027 — 33rd Annual Conference + PhD Colloquium", importance:"High", series:"PRRES, annual", url:"http://www.prres.net/", targetYear:"2027", date:"2027-01-10", endDate:"2027-01-13", location:"Curtin University, Perth, WA (Bentley)", topics:"Real estate, Property, University estates, Smart campus, PhD colloquium", abstractDue:"2026-09-30", paperDue:"", regDue:"2026-11-30", status:"Planning", lastChecked:"", notes:"Main conference Perth 10–13 Jan 2027 (register: payments.curtin.edu.au booking link Michael shared). PhD Colloquium listed as Sun 17 Jan 2027 in the colloquium PDF — CONFIRM the colloquium day vs 10–13 Jan main conf. Submit 3-page research summary + 150-word abstract + application form + supervisor declaration (PRRES-member supervisor) + enrolment evidence to Dr Wejen Reddy (wejendra.reddy@rmit.edu.au) by 30 Sep 2026. Register by 30 Nov 2026 (PhD = early-bird rate). Acceptance advised 16 Nov 2026. Need a paper in the main conference. Scholarship AUD1,500 (2nd–4th-yr full-time, property); Best Paper AUD400 (1st yr); Best Presenter AUD400. Summary format: Word A4, TNR 12, single-space, Harvard, filename surname_colloquium." },
